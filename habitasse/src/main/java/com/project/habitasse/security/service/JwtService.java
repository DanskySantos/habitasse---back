package com.project.habitasse.security.service;
...
public class JwtService {
    ...
    public String generateTokenWithRole(UserDetails userDetails) {
        return generateTokenWithRole(new HashMap<>(), userDetails);
    }
    ...
    public String generateTokenWithRole(
        ...
        return buildToken(extraClaims, userDetails, jwtExpiration, claims);
    }

    public String generateRefreshToken(UserDetails userDetails) {
        return buildToken(new HashMap<>(), userDetails, refreshExpiration, null);
    }
